export const emailVerification = (title, desc, link) => {
  const html = `
<!DOCTYPE html>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">${desc}</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <h4
                                                                    ...
                                                                    <a href="${link}"
                                                                        style="background-color: #7747FF;color:white;padding:10px 30px;text-decoration: none; border-radius: 50px;">Open</a>
                                                                </h4>
                                                            ...
                                                            <td class="pad"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">Thank you,<br />
                                                                        <a href="#"
                                                                            target="_blank">Hospital Management</a>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
